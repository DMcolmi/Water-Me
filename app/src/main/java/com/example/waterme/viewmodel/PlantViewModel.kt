...
class PlantViewModel(application: Application): ViewModel() {
    ...
    internal fun scheduleReminder(
        ...
        val workData = Data.Builder().putString(WaterReminderWorker.nameKey, plantName).build()
        workData
        var workRequest = OneTimeWorkRequestBuilder<WaterReminderWorker>()
        ...
        workManager.beginUniqueWork(plantName,ExistingWorkPolicy.REPLACE,workRequest).enqueue()
